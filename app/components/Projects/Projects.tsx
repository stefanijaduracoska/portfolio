...
export const Projects = () => {
  ...
  const scrollByCard = (dir: 'left' | 'right') => {
    ...
    const gapValue = parent
      ? window.getComputedStyle(parent).columnGap
      : '16px';
  ...
  return (
    ...
    >
      <div className='mx-auto w-full max-w-6xl 2xl:max-w-410 px-5 sm:px-6 md:px-10 2xl:px-16'>
        <div className='mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between md:gap-6 2xl:mb-12'>
          <div className='max-w-md sm:max-w-lg 2xl:max-w-2xl'>
            ...
            <p className='mt-3 text-sm leading-6 text-neutral-400 sm:mt-4 2xl:text-lg 2xl:leading-8'>
        ...
        <div className='relative'>
          ...
          <div
            ref={scrollRef}
            className='overflow-x-auto overflow-y-visible py-3 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden 2xl:py-4'
          >
            <div className='flex w-max snap-x snap-mandatory gap-3 sm:gap-4 2xl:gap-6'>
